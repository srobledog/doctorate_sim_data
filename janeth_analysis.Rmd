...
```{r}
janneth_scopus <- 
  convert2df("data/Janneth_scopus.bib",
             dbsource = "scopus", 
             format = "bibtex")
write_csv(janneth_scopus, "data/Janneth_scopus.csv")
...
write_csv(janneth_nodes, "data/janneth_nodes.csv")
write_csv(janneth_edges, "data/janneth_edges.csv")
```
